...
const navigation = [
  ...
  { name: 'My Curricula', href: '/student/curricula', icon: BookOpen },
  { name: 'Browse Courses', href: '/student/browse', icon: BookOpen },
  { name: 'Tutorial Requests', href: '/student/requests', icon: FileText },
